...
@Named("tensorflow")
public class TensorflowApp extends BaseApp {

  private static Logger LOG = LoggerFactory.getLogger(TensorflowApp.class);
  ...
  private String genCmd(AppResource resource, String appUser,
      String workIndex, String workType, String config,
      String args, String entry) {
    String containerClazz = TensorflowContainerRunner.class.getName();
